...
class EcommerceSystem {
    ...
    Product addProduct(String name, String description, double price, int[] availableSizes) {
        Product temp_product = new Product(name, description, price, availableSizes.clone());
